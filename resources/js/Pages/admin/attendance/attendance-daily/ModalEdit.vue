...
const updateAttendance = async () => {
  ...
  axios
    .post(
      route("attendance.attendance-daily.updateAttendance"),
      {
        id: props.datas.id,
        clock_in: form.value.clock_in_current,
        clock_out: form.value.clock_out_current
      }
    )
    .then((res) => {
