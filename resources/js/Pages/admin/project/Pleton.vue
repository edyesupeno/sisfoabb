...
import AddModal from './AddArea.vue';
...
<template >
    <component v-if="!isdetail">
        ...
        <div class="mb-4 sm:mb-6 flex justify-between items-center">
            ...
            <VButton label="Tambah Area" type="primary" @click="handleAddModalForm" class="mt-auto" />
        </div>
        <div class="bg-white shadow-lg rounded-sm border border-slate-200"
            ...
            <VDataTable :heads="heads" :isLoading="isLoading">
                ...
                <tr v-for="(data, index) in query" :key="index" v-else>
                    ...
                    <td class="px-4 whitespace-nowrap h-16"> {{ data.nama }}<br>
                        <p v-for="(pleton, i) in data.pleton">- {{ pleton.nama }}</p>
                    </td>
        ...
        <td class="px-4 whitespace-nowrap h-16"> {{ data.branch }} </td> -->
                    <td class="flex  h-10 py-5   gap-1 w-52  ">
                        <VDetail class="flex-none cursor-pointer hover:bg-slate" color="3e403e"
                        ...
                        <VButton label="Tambah Pleton" type="primary" @click="handleAddModalFormple(data)"
                            class="flex-none" />
